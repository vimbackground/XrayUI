...
namespace XrayUI.Models
{
    ...
    /// page can stay a plain technical PR list. The first entry is the latest published
    /// release; both languages live side by side so one request is enough and a missing
    /// translation is visible at a glance while editing.
    /// </summary>
